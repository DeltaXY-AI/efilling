...
import { main as createMain } from "../twilio/scripts/create-filing-defect-templates";
import { main as verifyMain } from "../twilio/scripts/verify-filing-defect-templates";
import type { ContentResource, ContentTemplateSpec } from "../twilio/scripts/content-api-client";

const FILE_NAMES = [
  "case-status-actions.en.json",
  "case-status-actions.ml.json",
  "defect-alert-actions.en.json",
  "defect-alert-actions.ml.json",
  "defect-days.en.json",
  "defect-days.ml.json",
  "defect-review-actions.en.json",
  "defect-review-actions.ml.json",
  "defect-sent-actions.en.json",
  "defect-sent-actions.ml.json",
];
const ENV_VARS = [
  "TWILIO_CASE_STATUS_ACTIONS_SID_EN",
  "TWILIO_CASE_STATUS_ACTIONS_SID_ML",
  "TWILIO_DEFECT_ALERT_ACTIONS_SID_EN",
  "TWILIO_DEFECT_ALERT_ACTIONS_SID_ML",
  "TWILIO_DEFECT_DAYS_SID_EN",
  "TWILIO_DEFECT_DAYS_SID_ML",
  "TWILIO_DEFECT_REVIEW_ACTIONS_SID_EN",
  "TWILIO_DEFECT_REVIEW_ACTIONS_SID_ML",
  "TWILIO_DEFECT_SENT_ACTIONS_SID_EN",
  "TWILIO_DEFECT_SENT_ACTIONS_SID_ML",
];
...
describe("Twilio filing-defect Content Template scripts (#37)", () => {
  ...
  describe("create-filing-defect-templates", () => {
    it("creates all 10 templates when none exist yet", async () => {
    ...
    it("reuses all 10 templates without any create request when they already match", async () => {
      for (const spec of SPECS) {
  ...
  describe("verify-filing-defect-templates", () => {
    beforeEach(() => {
    ...
    it("succeeds when all 10 configured SIDs match their specifications", async () => {
