...
import { main as createMain } from "../twilio/scripts/create-filing-draft-list-templates";
import { main as verifyMain } from "../twilio/scripts/verify-filing-draft-list-templates";
import type { ContentResource, ContentTemplateSpec } from "../twilio/scripts/content-api-client";

const FILE_NAMES = [
  "filing-draft-list.en.json",
  "filing-draft-list.ml.json",
  "filing-draft-detail-actions.en.json",
  "filing-draft-detail-actions.ml.json",
];
const ENV_VARS = [
  "TWILIO_FILING_DRAFT_LIST_SID_EN",
  "TWILIO_FILING_DRAFT_LIST_SID_ML",
  "TWILIO_FILING_DRAFT_DETAIL_ACTIONS_SID_EN",
  "TWILIO_FILING_DRAFT_DETAIL_ACTIONS_SID_ML",
];
...
describe("Twilio filing-draft-list Content Template scripts (#36)", () => {
  ...
  describe("create-filing-draft-list-templates", () => {
    it("creates all 4 templates when none exist yet", async () => {
    ...
    it("reuses all 4 templates without any create request when they already match", async () => {
      for (const spec of SPECS) {
  ...
  describe("verify-filing-draft-list-templates", () => {
    beforeEach(() => {
    ...
    it("succeeds when all 4 configured SIDs match their specifications", async () => {
