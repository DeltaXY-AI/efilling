...
import { main as createMain } from "../twilio/scripts/create-filing-completion-templates";
import { main as verifyMain } from "../twilio/scripts/verify-filing-completion-templates";
import type { ContentResource, ContentTemplateSpec } from "../twilio/scripts/content-api-client";

const FILE_NAMES = ["filing-filed-actions.en.json", "filing-filed-actions.ml.json"];
const ENV_VARS = ["TWILIO_FILING_FILED_ACTIONS_SID_EN", "TWILIO_FILING_FILED_ACTIONS_SID_ML"];
...
describe("Twilio filing-completion Content Template scripts (#35)", () => {
  ...
  describe("create-filing-completion-templates", () => {
  ...
  describe("verify-filing-completion-templates", () => {
    beforeEach(() => {
